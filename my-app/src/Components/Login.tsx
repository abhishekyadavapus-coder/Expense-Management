...
const Login: React.FC = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900 p-4 font-sans">
             <div className="relative w-full max-w-4xl flex bg-white dark:bg-gray-800 shadow-2xl rounded-2xl overflow-hidden">
                <div className="w-1/2 hidden md:block bg-gradient-to-br from-indigo-500 to-purple-600 p-12 text-white flex flex-col justify-center">
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <input
                                    ...
                                    className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                />
                            </div>
                        </div>
